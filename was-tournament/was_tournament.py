...
from wasstrategies import luka_strategy as pl0
...
axl.TitForTat(), axl.Grudger(), pl0.Luka()]
...
# Play the tournament
results = tournament.play(filename="/Users/lukabekavac/PycharmProjects/axelrod-tournament-web-based/was-tournament/was_tournament_analysis.csv")
...
p1 = plot.boxplot()
p1.show()
p1.savefig('/Users/lukabekavac/PycharmProjects/axelrod-tournament-web-based/was-tournament/was_results.png')

# View the distributions of wins for each strategy
p2 = plot.winplot()
p2.show()
p2.savefig('/Users/lukabekavac/PycharmProjects/axelrod-tournament-web-based/was-tournament/was_win_distributions.png')

# View the payoff matrix
p2 = plot.payoff()
p2.show()
p2.savefig('/Users/lukabekavac/PycharmProjects/axelrod-tournament-web-based/was-tournament/was_payoff_matrix.png')
